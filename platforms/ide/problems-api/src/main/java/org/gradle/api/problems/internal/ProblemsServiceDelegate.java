...
public class ProblemsServiceDelegate implements InternalProblemReporter {

    private final ProblemEmitter emitter;
    private final List<ProblemTransformer> transformers;
    private final String namespace;

    ProblemsServiceDelegate(ProblemEmitter emitter, List<ProblemTransformer> transformers, String namespace) {
